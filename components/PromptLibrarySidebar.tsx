...
const PromptLibrarySidebar: React.FC<PromptLibrarySidebarProps> = ({ isOpen, onClose, prompts, onPromptSelect }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={`fixed top-0 left-0 h-full w-80 bg-white dark:bg-slate-800 z-40 shadow-lg transform transition-transform duration-300 ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
